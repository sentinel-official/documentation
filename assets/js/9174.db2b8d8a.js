...
const DyteChatToggle = class {
  constructor(hostRef) {
    ...
    this.updateCanView = () => {
      this.canViewChat = (0,_sidebar_ada3073b_js__WEBPACK_IMPORTED_MODULE_5__.c)(this.meeting);
    };
    this.unreadMessageCount = 0;
    this.variant = 'button';
  ...
  meetingChanged(meeting) {
    ...
    this.canViewChat = (0,_sidebar_ada3073b_js__WEBPACK_IMPORTED_MODULE_5__.c)(meeting);
